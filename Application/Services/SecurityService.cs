...
namespace EcommerceBackend.Application.Services
{
    public class SecurityService : ISecurityService
    {
        ...
        public Task<BaseResponseDto<SecuritySettingsDto>> GetSecuritySettingsAsync(int userId)
        {
            try
            {
                ...
                return Task.FromResult(BaseResponseDto<SecuritySettingsDto>.SuccessResult("Security settings retrieved successfully", settings));
            }
            catch (Exception ex)
            {
                return Task.FromResult(BaseResponseDto<SecuritySettingsDto>.ErrorResult($"Error retrieving security settings: {ex.Message}"));
            }
        }

        public Task<BaseResponseDto<SecuritySettingsDto>> UpdateSecuritySettingsAsync(int userId, SecuritySettingsDto securitySettingsDto)
        {
            try
            {
                return Task.FromResult(BaseResponseDto<SecuritySettingsDto>.SuccessResult("Security settings updated successfully", securitySettingsDto));
            }
            catch (Exception ex)
            {
                return Task.FromResult(BaseResponseDto<SecuritySettingsDto>.ErrorResult($"Error updating security settings: {ex.Message}"));
            }
        }

        public Task<BaseResponseDto<string>> LogoutAllDevicesAsync(int userId)
        {
            try
            {
                return Task.FromResult(BaseResponseDto<string>.SuccessResult("All devices logged out successfully", "All devices logged out successfully"));
            }
            catch (Exception ex)
            {
                return Task.FromResult(BaseResponseDto<string>.ErrorResult($"Error logging out all devices: {ex.Message}"));
            }
        }
    }
}
