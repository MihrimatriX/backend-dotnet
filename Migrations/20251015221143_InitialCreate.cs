        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeLeft = table.Column<string>(type: "text", nullable: true),
                    button_text = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    quantity_per_unit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    action_url = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cvv = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    profile_visibility = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    show_email = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    show_phone = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    allow_data_collection = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    allow_analytics = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    allow_cookies = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    allow_marketing = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    data_sharing = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    marketing_emails = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    order_updates = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    price_alerts = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    stock_notifications = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ...
                    auto_save_cart = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    show_product_recommendations = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    enable_location_services = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    message = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    is_from_support = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
